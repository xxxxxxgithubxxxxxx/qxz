...
<script>
	...
	export default {
		...
		mounted(){
			...
			axios.get("/api/v4/new_get_topics?start=0&count=5&channel_id=10").then(res => {
		...
		methods:{
			loadMore(){
				...
				axios.get(`/api/v4/new_get_topics?start=${this.current}&count=5&channel_id=10`).then(res=>{
