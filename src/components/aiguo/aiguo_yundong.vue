...
<script>
	...
	export default {
		...
		mounted() {
			Indicator.open('加载中...');
			axios.get("/api/v4/new_get_topics?start=0&count=10&channel_id=5").then(res => {
//				console.log(res.data);
		...
		methods:{
			loadMore(){
				...
				axios.get(`/api/v4/new_get_topics?start=${this.current}&count=10&channel_id=5`).then(res=>{
